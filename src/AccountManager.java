...
public class AccountManager {
	public static void main(String[] args) {
		...
		deposit[0] = new Depositor(account[0],0);
		deposit[1] = new Depositor(account[1],1);
		deposit[2] = new Depositor(account[2],2);
		deposit[3] = new Depositor(account[3],3);
		deposit[4] = new Depositor(account[4],4);
		deposit[5] = new Depositor(account[5],5);
		deposit[6] = new Depositor(account[6],6);
		deposit[7] = new Depositor(account[7],7);
		deposit[8] = new Depositor(account[8],8);
		deposit[9] = new Depositor(account[9],9);

		// The birth of  10 withdraws 
		withdraw[0] = new Withdrawer(account[0],10);
		withdraw[1] = new Withdrawer(account[1],11);
		withdraw[2] = new Withdrawer(account[2],12);
		withdraw[3] = new Withdrawer(account[3],13);
		withdraw[4] = new Withdrawer(account[4],14);
		withdraw[5] = new Withdrawer(account[5],15);
		withdraw[6] = new Withdrawer(account[6],16);
		withdraw[7] = new Withdrawer(account[7],17);
		withdraw[8] = new Withdrawer(account[8],18);
		withdraw[9] = new Withdrawer(account[9],19);
